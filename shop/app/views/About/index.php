...
<main class="main-content">
            ...
            <div class="row h-100">
                <div class="col-lg-12">
                    <div class="breadcrumb-item">
                        <h1 class="breadcrumb-heading">О нас</h1>
                        <ul>
                            <li>
                                <a href="<?= PATH; ?>">Домой</a>
                            </li>
                ...
                <div class="col-lg-12">
                    <div class="about-content">
                        ...
                        <div class="about-signature">
                            <img src="/shop/public/images/about/icon/2.png" alt="Signature">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="shipping-bg">
                <div class="row shipping-wrap">
                    <div class="col-lg-4 col-md-6">
                        <div class="shipping-item">
                            <div class="shipping-img">
                                <img src="/shop/public/images/shipping/icon/car.png" alt="Shipping Icon">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
                        <div class="shipping-item">
                            <div class="shipping-img">
                                <img src="/shop/public/images/shipping/icon/card.png" alt="Shipping Icon">
                            </div>
                            <div class="shipping-content">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
                        <div class="shipping-item">
                            <div class="shipping-img">
                                <img src="/shop/public/images/shipping/icon/service.png" alt="Shipping Icon">
                            </div>
                            <div class="shipping-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-boxshadow">
                            <div class="banner-item" data-bg-image="/shop/public/images/banner/3-1-1208x542.jpg">
                                <div class="popup-btn">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 pt-sm-5">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="/shop/public/images/about/team/1-1-270x270.png" alt="Team Member">
                ...
                <div class="col-lg-3 col-sm-6 pt-5 pt-sm-0">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="/shop/public/images/about/team/1-2-270x270.png" alt="Team Member">
                            <div class="inner-content">
                ...
                <div class="col-lg-3 col-sm-6 pt-5">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="/shop/public/images/about/team/1-3-270x270.png" alt="Team Member">
                            <div class="inner-content">
                ...
                <div class="col-lg-3 col-sm-6 pt-5 pt-sm-0">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="/shop/public/images/about/team/1-4-270x270.png" alt="Team Member">
                            <div class="inner-content">
    ...
    <div class="brand-area section-space-y-axis-100">
        <div class="container">
            <div class="brand-bg" data-bg-image="/shop/public/images/brand/bg/1-1170x300.jpg">
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a class="brand-item" href="#">
                                        <img src="/shop/public/images/brand/1-1.png" alt="Brand Image">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a class="brand-item" href="#">
                                        <img src="/shop/public/images/brand/1-2.png" alt="Brand Image">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a class="brand-item" href="#">
                                        <img src="/shop/public/images/brand/1-3.png" alt="Brand Image">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a class="brand-item" href="#">
                                        <img src="/shop/public/images/brand/1-4.png" alt="Brand Image">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a class="brand-item" href="#">
                                        <img src="/shop/public/images/brand/1-5.png" alt="Brand Image">
                                    </a>
                                </div>
                            </div>
                        </div>
